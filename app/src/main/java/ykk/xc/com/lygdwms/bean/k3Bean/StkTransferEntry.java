...
/**
 * 直接调拨单分录 ( t_Stk_stktransferinEntry )
 */
public class StkTransferEntry implements Serializable {
	...
	private StkTransfer stkTransfer;
	private Material_K3 material;
	private Unit_K3 unit;
	
	public StkTransferEntry() {
		super();
	}
	...
	public StkTransfer getStkTransfer() {
		return stkTransfer;
	}

	public void setStkTransfer(StkTransfer stkTransfer) {
		this.stkTransfer = stkTransfer;
	}
