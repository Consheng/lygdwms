...
class Supplier_DialogAdapter(private val context: Activity, private val datas: List<Supplier>) : BaseArrayRecyclerAdapter<Supplier>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: Supplier, pos: Int) {
        // 初始化id
