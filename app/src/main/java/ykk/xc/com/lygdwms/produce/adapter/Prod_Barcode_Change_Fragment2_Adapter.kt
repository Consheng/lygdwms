...
class Prod_Barcode_Change_Fragment2_Adapter(private val context: Activity, datas: List<BarcodeTableChange>) : BaseArrayRecyclerAdapter<BarcodeTableChange>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.prod_barcode_change_fragment2_item
    }
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: BarcodeTableChange, pos: Int) {
        ...
        tv_newBarcode.text = Html.fromHtml("拆码:&nbsp;<font color='#009900'>"+ entity.newBarcode +"</font>")
