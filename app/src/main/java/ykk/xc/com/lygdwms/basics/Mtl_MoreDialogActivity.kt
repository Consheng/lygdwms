...
import ykk.xc.com.lygdwms.basics.adapter.Mtl_MoreDialogAdapter
import ykk.xc.com.lygdwms.bean.Stock
import ykk.xc.com.lygdwms.bean.StockArea
...
class Mtl_MoreDialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<Material_K3>()
    ...
    private var stockPosition :StockPosition? = null    // 盘点的库位
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Material_K3::class.java)
    ...
    override fun initData() {
        ...
        if (bundle != null) {
            ...
            if(bundle.containsKey("stockPosition")) stockPosition = bundle.getSerializable("stockPosition") as StockPosition
            if(stock != null) { // 默认选中仓库
                clickStock = 1
                btn_stock.text = stock!!.fname
            ...
            if(stockPosition != null) {
                btn_stockPos.text = stockPosition!!.fname
    ...
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.btn_confirm -> {// 确认
                ...
                val listMtl = ArrayList<Material_K3>()
    ...
    private fun run_okhttpDatas() {
        ...
        val stockPosId2 = if(clickStockPos > 0 && stockPosition != null) stockPosition!!.id.toString() else ""
