...
import ykk.xc.com.lygdwms.basics.adapter.StockPos_DialogAdapter
...
class StockPos_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<StockPosition>()
    ...
    private var storageRackId: Int = 0 // 货架id
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, StockPosition::class.java)
