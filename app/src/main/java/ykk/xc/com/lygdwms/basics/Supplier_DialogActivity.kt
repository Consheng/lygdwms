...
import ykk.xc.com.lygdwms.basics.adapter.Supplier_DialogAdapter
import ykk.xc.com.lygdwms.bean.Supplier
...
class Supplier_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<Supplier>()
    ...
    private var checkDatas: List<Supplier>? = null // 上个界面传过来的供应商列表
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Supplier::class.java)
