...
import ykk.xc.com.lygdwms.bean.AppInfo
import ykk.xc.com.lygdwms.comm.ActivityCollector
import ykk.xc.com.lygdwms.comm.BaseActivity
import ykk.xc.com.lygdwms.util.IDownloadContract
import ykk.xc.com.lygdwms.util.IDownloadPresenter
...
class MainTabFragmentActivity : BaseActivity(), IDownloadContract.View {
    ...
    //    val fragment0 = MainTabFragment1()
...
//        listFragment.add(MainTabFragment5())
        //ViewPager设置适配器
    ...
    private fun showNoticeDialog(remark: String) {
        val alertDialog = AlertDialog.Builder(context)
            ...
            .setPositiveButton("下载") { dialog, which ->
                ...
                val url = "$http://$ip:$port/apks/glswms.apk"
