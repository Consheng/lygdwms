...
class Stock_DialogAdapter(private val context: Activity, private val datas: List<Stock>) : BaseArrayRecyclerAdapter<Stock>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: Stock, pos: Int) {
        // 初始化id
