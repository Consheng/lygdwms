package ykk.xc.com.lygdwms.basics
...
import ykk.xc.com.lygdwms.basics.adapter.ShippingListTitle_DialogAdapter
import ykk.xc.com.lygdwms.bean.ShippingListTitle
import ykk.xc.com.lygdwms.comm.BaseDialogActivity
import ykk.xc.com.lygdwms.util.JsonUtil
import ykk.xc.com.lygdwms.util.basehelper.BaseRecyclerAdapter
import ykk.xc.com.lygdwms.util.xrecyclerview.XRecyclerView
 ...
 * 选择出库清单标题dialog
 */
class ShippingListTitle_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ShippingListTitle>()
    private var mAdapter: ShippingListTitle_DialogAdapter? = null
    ...
    private class MyHandler(activity: ShippingListTitle_DialogActivity) : Handler() {
        private val mActivity: WeakReference<ShippingListTitle_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ShippingListTitle::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.shippinglist_title_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = ShippingListTitle_DialogAdapter(context, listDatas)
